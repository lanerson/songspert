# Generated by Django 5.1.7 on 2025-05-18 00:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('genre', models.CharField(blank=True, max_length=100)),
                ('challenge_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='challenges', to='core.challengeset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('challenge_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.challengeset')),
            ],
        ),
        migrations.CreateModel(
            name='GameRoom',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('challenge_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.challengeset')),
