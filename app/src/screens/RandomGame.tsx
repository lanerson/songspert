...
const styles = StyleSheet.create({
  ...
  options:       { flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', width: '100%' }, 
  option:        { width: '100%', backgroundColor: '#E8F0FE', paddingVertical: 14, borderRadius: 25, marginBottom: 12, justifyContent: 'center', alignItems: 'center', elevation: 2, marginTop : 6 },
